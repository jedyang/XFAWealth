 ...
 * All rights reserved.
 */
package com.fsll.api.member.vo;
...
public class MemberSsoVO {
    ...
    private String defCurrencyName;
	...
	public String getDefCurrencyName() {
		return defCurrencyName;
	}
	public void setDefCurrencyName(String defCurrencyName) {
		this.defCurrencyName = defCurrencyName;
	}
