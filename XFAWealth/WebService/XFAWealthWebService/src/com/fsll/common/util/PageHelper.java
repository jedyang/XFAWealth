...
public class PageHelper {
	 ...
	 * @return
	 */
	public static String getUserHeadUrlNoLogin(String url){
		if(null!=url && !"".equals(url)){
			if(url.startsWith("/res")){
				return url;
			}else if (url.startsWith("/u")) {
				return "/loadImgSrcByPathNoLogin.do?filePath="+url;
			}else {
				return "/res/images/common/portrait.png";
			}
		}else {
	 ...
	 * @return
	 */
	public static String getUserHeadUrlForWS(String url,String gender){
		if(null!=url && !"".equals(url)){
			if(url.startsWith("/res")){
				return url;
			}else if (url.startsWith("/u")) {
				return "/service/common/loadImg.r?filePath="+url;
			}else {
				return "/res/images/common/portrait.png";
				/*if("F".startsWith(StrUtils.getString(gender).toUpperCase())){
					return "/res/images/common/portrait_f.png";
	 ...
	 * @return
	 */
	public static String getLogoUrlForWS(String url,String type){
		if(null!=url && !"".equals(url)){
			if(url.startsWith("/res")){
				return url;
			}else if (url.startsWith("/u")) {
	 ...
	 * @return
	 */
	public static String getImgUrlForWS(String url){
		if(null!=url && !"".equals(url)){
			if(url.startsWith("/res")){
				return url;
			}else if (url.startsWith("/u")) {
	...
	/**
     * 检测网络上的图片是否存在，不存在则返回空
     * @author mqzou 2017-03-14
     * @param url
     * @return
     */
    public static String getNetImgUrl(String urlStr){
    	try {
