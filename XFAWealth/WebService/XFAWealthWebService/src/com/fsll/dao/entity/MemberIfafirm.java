...
public class MemberIfafirm implements java.io.Serializable {
    ...
    @Column(name = "ifafirm_code")
	private String ifafirmCode;
	...
	public String getIfafirmCode() {
		return ifafirmCode;
	}

	public void setIfafirmCode(String ifafirmCode) {
		this.ifafirmCode = ifafirmCode;
	}
