 ...
 */
 define(function(require, exports, module) {
    ...
    $.upLoadDefaults.property = {
        ...
        sendurl: null, //发送地址
        filetypes: "jpg,jpge,png,gif,jpeg,doc,docx,pdf,xls,xlsx", //文件类型
        filesize: "2048", //文件大小
        lang:"en",
        btntext: "浏览...", //上传按钮的文字
    ...
    $.fn.InitUploader = function (b) { 
        ...
        var fun = function (parentObj) {//console.log(parentObj);
    		...
    		var dialoginfotitle = 'Info';
    		var confirmbtnname = 'OK';
    		if(p.lang=='sc')confirmbtnname='确定';
    		if(p.lang=='tc')confirmbtnname='確定';
    		if(p.lang=='sc')dialoginfotitle='提示';
    		if(p.lang=='tc')dialoginfotitle='提示';
            ...
            uploader.on('error', function (type) {
                switch (type) {
                    case 'Q_EXCEED_NUM_LIMIT':
                    	if(p.lang=='en')layer.alert("Error：Upload files to marry!",{ title:dialoginfotitle, btn: [confirmbtnname]});
                    ...
                    case 'Q_EXCEED_SIZE_LIMIT':
                    	if(p.lang=='en')layer.alert("Error：Total file size exceeds limit!",{ title:dialoginfotitle, btn: [confirmbtnname]});
                        ...
                        break;
                    case 'F_EXCEED_SIZE':
                    	if(p.lang=='en')layer.alert("Error： File size exceeds limit!",{ title:dialoginfotitle, btn: [confirmbtnname]});
                        ...
                        break;
                    case 'Q_TYPE_DENIED':
                    	if(p.lang=='en')layer.alert("Error： Forbidden to upload the file type!",{ title:dialoginfotitle, btn: [confirmbtnname]});
                        ...
                        break;
                    default:
	                    if(p.lang=='en')layer.alert("Error code：" + type,{ title:dialoginfotitle, btn: [confirmbtnname]});
