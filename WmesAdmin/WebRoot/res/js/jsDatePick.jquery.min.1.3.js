define(function(require, exports, module) {
	...
	g_l = [];
	g_jsDatePickImagePath = base_root +"/res/images/data/";
	...
	if(lang == "en"){
		...
		g_l.MONTHS = ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"];
		...
		g_l.YEAR_BCK = "上一年";
		g_l.CLOSE = "关闭日历";
		g_l.ERROR_2 = g_l.ERROR_1 = "无效的日期对象!";
		g_l.ERROR_4 = g_l.ERROR_3 = "目标无效!";
	}else if(lang == "tc"){
		g_l.MONTHS = ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"];
		g_l.DAYS_3 = ["日", "一", "二", "三", "四", "五", "六"];
		g_l.MONTH_FWD = "下一個月";
		...
		g_l.YEAR_BCK = "上一年";
		g_l.CLOSE = "關閉日曆";
		g_l.ERROR_2 = g_l.ERROR_1 = "無效的日期對象!";
		g_l.ERROR_4 = g_l.ERROR_3 = "目標無效!";
	}else{//默认简体
		g_l.MONTHS = ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"];
		g_l.DAYS_3 = ["日", "一", "二", "三", "四", "五", "六"];
		g_l.MONTH_FWD = "下一个月";
	...
	JsDatePick.prototype.setConfiguration = function(a) {
		...
		this.oConfiguration.imgPath = (g_jsDatePickImagePath.length != null) ? g_jsDatePickImagePath : "../images/data";
