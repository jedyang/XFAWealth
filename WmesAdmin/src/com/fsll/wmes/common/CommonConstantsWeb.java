...
public class CommonConstantsWeb {
	...
	//定义产品信息类型product_info.type ：fund基金,stock股票,bond债券,futures期货
	...
	//WEB_READ_TO_DO 发送消息模块：insight关点,news新闻
	...
	// 社区评论对象 community_comment.target
	public static final String COMMUNITY_COMMENT_TARGET_TOPIC = "topic";
	public static final String COMMUNITY_COMMENT_TARGET_QUESTION = "question";
	
	// 公告来源 notice.source_type
