...
public class WorkFlowServiceImpl extends BaseService implements WorkFlowService {
     ...
     * @author 林文伟
     * @date 2016-06-29
     * modify 新增流程编码查询hql语句   rqwang 170510
     */
	@Override
	...
	public JsonPaging findAll(JsonPaging jsonpaging, WfProcedureInfo infoList) {
		...
		if(null!=infoList.getInvokCode()&&!"".equals(infoList.getInvokCode())){
			hql+=" and invokCode like '%"+infoList.getInvokCode()+"%'";
		}
		hql += " ORDER BY is_del DESC";
	...
	public JsonPaging findActionAll(JsonPaging jsonpaging, String procedureId) {
		String hql=" from WfProcedureAction r where procedure.id=? ";
		List<Object> params=new ArrayList<Object>();
