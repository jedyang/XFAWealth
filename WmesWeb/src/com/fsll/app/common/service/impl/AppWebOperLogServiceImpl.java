 ...
 * @date 2016-6-13
 */
@Service("appWebOperLogService")
//@Transactional
public class AppWebOperLogServiceImpl extends BaseService implements AppWebOperLogService {
	...
	public JsonPaging findAll(JsonPaging jsonpaging,WebOperLog log) {
		...
		String endTimeStr = log.getEndTime();
...
//		}	
		Date startTime = DateUtil.getDate(startTimeStr, "yyyy-MM-dd HH:mm:ss");
		Date endTime = DateUtil.getDate(endTimeStr, "yyyy-MM-dd HH:mm:ss");;
