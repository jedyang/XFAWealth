 ...
 * @date 2016-9-14
 */
public class AppPortfolioProductDetailVO {
	private String id;
	...
	private List<AppPortfolioHoldProductCumperfVO> cumperfList;
	private List<AppPortfolioOrderHistoryVO> orderHistoryList;
	...
	public List<AppPortfolioHoldProductCumperfVO> getCumperfList(){
		return cumperfList;
	}
	
	public void setCumperfList(List<AppPortfolioHoldProductCumperfVO> cumperfList){
		this.cumperfList = cumperfList;
	}
	
	public List<AppPortfolioOrderHistoryVO> getOrderHistoryList(){
		return orderHistoryList;
	}
	
	public void setOrderHistoryList(List<AppPortfolioOrderHistoryVO> orderHistoryList){
