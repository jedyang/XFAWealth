...
public class AppMyAccountInfoVO {
	private String accountId;//交易账号
	private String accountNo;//交易账号
	private String accountCurrency;//账号货币
	...
	private String ifaName;//Ifa
	private String ifaIcon;//Ifa
	...
	public String getIfaIcon(){
		return ifaIcon;
	}
	public void setIfaIcon(String ifaIcon) {
		this.ifaIcon = ifaIcon;
	}
