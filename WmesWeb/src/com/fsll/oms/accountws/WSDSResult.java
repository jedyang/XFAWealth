...
public class WSDSResult  extends com.fsll.oms.accountws.WSResult  implements java.io.Serializable {
    private com.fsll.oms.accountws.WSDSResultDataSet dataSet;
    ...
    public WSDSResult(
           ...
           com.fsll.oms.accountws.WSDSResultDataSet dataSet) {
        super(
            errorCode,
            errorMessage);
     ...
     * @return dataSet
     */
    public com.fsll.oms.accountws.WSDSResultDataSet getDataSet() {
        return dataSet;
    }
     ...
     * @param dataSet
     */
    public void setDataSet(com.fsll.oms.accountws.WSDSResultDataSet dataSet) {
        this.dataSet = dataSet;
    }
