...
public class OMSAPIWebServiceLocator extends org.apache.axis.client.Service implements com.fsll.oms.accountws.OMSAPIWebService {
    ...
    private java.lang.String OMSAPIWebServiceSoap12_address = "http://210.177.6.140/OMSWebAPI/OMSAPIWS.asmx";
    ...
    public com.fsll.oms.accountws.OMSAPIWebServiceSoap getOMSAPIWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.fsll.oms.accountws.OMSAPIWebServiceSoap12Stub _stub = new com.fsll.oms.accountws.OMSAPIWebServiceSoap12Stub(portAddress, this);
    ...
    private java.lang.String OMSAPIWebServiceSoap_address = "http://210.177.6.140/OMSWebAPI/OMSAPIWS.asmx";
    ...
    public com.fsll.oms.accountws.OMSAPIWebServiceSoap getOMSAPIWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.fsll.oms.accountws.OMSAPIWebServiceSoapStub _stub = new com.fsll.oms.accountws.OMSAPIWebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.fsll.oms.accountws.OMSAPIWebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.fsll.oms.accountws.OMSAPIWebServiceSoap12Stub _stub = new com.fsll.oms.accountws.OMSAPIWebServiceSoap12Stub(new java.net.URL(OMSAPIWebServiceSoap12_address), this);
                _stub.setPortName(getOMSAPIWebServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (com.fsll.oms.accountws.OMSAPIWebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.fsll.oms.accountws.OMSAPIWebServiceSoapStub _stub = new com.fsll.oms.accountws.OMSAPIWebServiceSoapStub(new java.net.URL(OMSAPIWebServiceSoap_address), this);
                _stub.setPortName(getOMSAPIWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
