...
public class LogoffResponse  implements java.io.Serializable {
    private com.fsll.oms.accountws.WSResult logoffResult;

    public LogoffResponse() {
    }

    public LogoffResponse(
           com.fsll.oms.accountws.WSResult logoffResult) {
     ...
     * @return logoffResult
     */
    public com.fsll.oms.accountws.WSResult getLogoffResult() {
        return logoffResult;
    }
     ...
     * @param logoffResult
     */
    public void setLogoffResult(com.fsll.oms.accountws.WSResult logoffResult) {
        this.logoffResult = logoffResult;
    }
