...
public class EHCacheUtil {
    ...
    public <K,V> CacheManager getCacheManager(Class<K> kClass,Class<V> vClass,String configureName){
        CacheManager manager =  CacheManagerBuilder.newCacheManagerBuilder().withCache(configureName,CacheConfigurationBuilder.newCacheConfigurationBuilder(kClass, vClass, ResourcePoolsBuilder.heap(10))).build();
        manager.init();
        return manager;
    }
