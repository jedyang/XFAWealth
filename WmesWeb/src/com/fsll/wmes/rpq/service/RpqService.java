...
public interface RpqService {
	...
	// find list -------------
	public RpqPageLevel findRpqPageLevel( String pageId, Integer score, String status, String isValid,String langCode );
	//查询等于少于指定分数的问卷评级
	public List<RpqPageLevel> findRpqPageLevelByScore( String pageId, Integer score, String status, String isValid,Integer riskLevel,String langCode );
	//查询等于少于指定风险级别的问卷评级
	public List<RpqPageLevel> findRpqPageLevelList( String pageId, String status, String isValid,Integer riskLevel,String langCode );
	 ...
	 * @param pageType :此问题适用类型, O:开户rpq I:投资方案的rpq,K:KYC中使用的rpq,其他类型自行扩展
	 */
	public List<RpqListVO> findRpqQuestList( String type, String distributorId, String clientType, String langCode, String pageType );
...
//用户风险评级（提交后）
	 ...
	 * @param langCode 语音
	 */
	public RpqExam saveCompleteExam(String levelId,String userLevelId,String examId,int score);
	/**
	 * 获取已经答过题的问卷，包含问题及选项
	 * @author qgfeng
	 * @date 2016-11-14
