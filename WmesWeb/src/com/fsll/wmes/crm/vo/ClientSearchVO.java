...
public class ClientSearchVO {
	...
	public String getMinAuM() {
		return minAuM;
	}
	public void setMinAuM(String minAuM) {
		this.minAuM = minAuM;
	}
	public String getMaxAuM() {
		return maxAuM;
	}
	public void setMaxAuM(String maxAuM) {
		this.maxAuM = maxAuM;
	}
	...
	public String getMaxMarket() {
		return maxMarket;
	}
	public void setMaxMarket(String maxMarket) {
