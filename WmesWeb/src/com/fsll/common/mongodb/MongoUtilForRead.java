 ...
 */
public class MongoUtilForRead {
	
	private static final String MONGOHOST = PropertyUtils.getConfDbPropertyValue("rmongo.host");
	private static final int MONGOPORT = Integer.parseInt(PropertyUtils.getConfDbPropertyValue("rmongo.port"));
	private static final String MONGODB = PropertyUtils.getConfDbPropertyValue("rmongo.db");
	private static final String MONGOUSER = PropertyUtils.getConfDbPropertyValue("rmongo.user");
	private static final String MONGOPWD = PropertyUtils.getConfDbPropertyValue("rmongo.pwd");
    ...
    private static MongoUtilForRead MONGOUTIL = null;
	...
	private MongoUtilForRead() {
		
	}

	public static MongoUtilForRead getInstance() {
		if (MONGOUTIL == null) {
			MONGOUTIL = new MongoUtilForRead();
		}
		return MONGOUTIL;
	}
