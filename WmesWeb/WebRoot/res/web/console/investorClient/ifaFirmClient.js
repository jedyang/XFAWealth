...
// getDataList();
			...
			$(".proposal_xiala li").on("click",function(e){
				var curName = $("#curName");
				var curCode = $("#currency");
				$(this).parents(".proposal_xiala").toggleClass("xiala-show").find(curCode).val($(this).attr("curcode"));
				$(this).parents(".proposal_xiala").find(curName).val($(this).html());
				e.stopPropagation(); 
				Initialization();
			});
