...
define(function(require) {
    ...
    mybase.controller('Searchctrl', ['$scope', '$http', function($scope, $http) {
	 		var url = base_root + "/front/distributor/accountListJson.do", // url
	 			//iPAGE = 1, // 第N页数据
	    	...
	    	function getDataList(iPAGE){
	    		...
	    		var   data ="rows="+ rows +"&page=" + iPAGE + "&ifafirmId="+ifafirmId+"&accountStatus="+accountStatus+"&docDate="+docDate+"&cur="+currency+"&rpqDate="+rpqDate
