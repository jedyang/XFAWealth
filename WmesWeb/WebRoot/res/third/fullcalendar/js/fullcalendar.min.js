...
function(t) {
    ...
    function ct(n, i, r) {
        ...
        return e.isMoment(u) || j(u) || void 0 === u ? a = e.apply(null, n) : (s = !1, o = !1, c ? Qt.test(u) ? (u += "-01", n = [u], s = !0, o = !0) : (l = Jt.exec(u)) && (s = !l[5], o = !0) : t.isArray(u) && (o = !0), a = i || s ? e.utc.apply(e, n) : e.apply(null, n), s ? (a._ambigTime = !0, a._ambigZone = !0) : r && (o ? a._ambigZone = !0 : c && a.utcOffset(u))),
        a._fullCalendar = !0,
        a
    }
    function dt(t, e) {
    ...
    function At(n, i) {
        ...
        function c(e, n) {
            ...
            K && (tt = K.massageCurrentDate(tt), K.displaying && tt >= K.intervalStart && tt < K.intervalEnd || u() && (K.display(tt, n), A(), H(), T(), E())),
            A(),
            lt--
        }
        function d() {
        ...
        function Y(t) {
            ...
            for (e in t) j.triggerOptionHandlers(e),
            n++;
            if (1 === n) {
                ...
                if ("timezone" === e) return j.rezoneArrayEventSources(),
                void y()
            }
            l(),
            ot = {},
        ...
        j.viewSpecCache = {},
        j.optionHandlers = {},
        j.overrides = t.extend({},
        i),
        j.populateOptionsHash();
        var U;
        j.bindOptions(["locale", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"],
    ...
    function _t(e) {
        function n() {
            ...
            s = n.header;
            f = n.theme ? "ui": "fc",
            s ? (h ? h.empty() : h = this.el = t("<div class='fc-toolbar'/>"), h.append(r("left")).append(r("right")).append(r("center")).append('<div class="fc-clear"/>')) : i()
        }
        function i() {
    ...
    function Yt() {
        ...
        function a(e, n) {
            ...
            var o = e.events;
            if (o) t.isFunction(o) ? (F.pushLoading(), o.call(F, A.clone(), V.clone(), F.options.timezone,
            function(t) {
                n(t),
                F.popLoading()
            })) : t.isArray(o) ? n(o) : n();
        ...
        function C(t, e) {
            var n, i, r, s = R(t);
            if (s) {
                for (n = M(s), i = 0; i < n.length; i++) r = n[i],
        ...
        function T(e) {
            return t.isFunction(e) ? t.grep(j, e) : null != e ? (e += "", t.grep(j,
            function(t) {
                return t._id == e
            })) : j
        }
        ...
        W = 0,
        j = [];
        t.each((F.options.events ? [F.options.events] : []).concat(F.options.eventSources || []),
        function(t, e) {
            var n = c(e);
            n && Y.push(n)
        }),
    ...
    ge = jt.Grid = wt.extend(le, ae, {
        ...
        dayTouchStart: function(t) {
            var e = this.view; (e.isSelected || e.selectedEvent) && this.tempIgnoreMouse(),
    ...
    ge.mixin({
        ...
        buildBusinessHourSegs: function(e) {
            ...
            return ! n.length && this.view.calendar.options.businessHours && (n = [t.extend({},
            xe, {
                start: this.view.end,
                end: this.view.end,
                dow: null
        ...
        handleSegTouchStart: function(t, e) {
            ...
            a || !o && !l || (n = o ? this.buildSegDragListener(t) : this.buildSegSelectListener(t), n.startInteraction(e, {
        ...
        buildSegDragListener: function(t) {
            ...
            var d = this.segDragListener = new he(l, {
                ...
                interactionEnd: function(s) {
                    ...
                    n.stop(!i,
                    function() {
                        e && (l.unrenderDrag(), l.showEvent(c), r.segDragStop(t, s)),
        ...
        invertRanges: function(t) {
            ...
            o = [],
            l = r;
            for (t.sort(kt), e = 0; e < t.length; e++) n = t[e],
            n.start > l && o.push({
                start: l,
                end: n.start
            }),
    ...
    var ye = jt.View = wt.extend(oe, le, {
        ...
        display: function(t, e) {
            ...
            ut(this.clear(),
            function() {
                return n.displaying = ut(n.displayView(t),
                function() {
    ...
    we = jt.Calendar = wt.extend({
        ...
        getUnitViewSpec: function(e) {
            var n, i, r;
            if (t.inArray(e, Xt) != -1) for (n = this.header.getViewsWithButtons(), t.each(jt.views,
            function(t) {
                n.push(t)
    ...
    we.prototype.expandBusinessHourEvents = function(e, n, i) {
        ...
        i && !s.dow || (s = t.extend({},
        xe, s), e && (s.start = null, s.end = null), l.push.apply(l, this.expandEvent(this.buildEventFromInput(s), o.start, o.end)));
        return l
    };
    ...
    var Le = jt.AgendaView = ye.extend({
        ...
        setHeight: function(t, e) {
            ...
            this.dayGrid && (this.dayGrid.removeSegPopover(), n = this.opt("eventLimit"), n && "number" != typeof n && (n = Be), n && this.dayGrid.limitRows(n)),
    ...
    Ge = ge.extend({
        ...
        spanToSegs: function(t) {
            for (var e, n, i = this.view,
            r = i.start.clone(), s = []; r < i.end;) e = r.clone().add(1, "day"),
            n = F(t, {
                start: r,
                end: e
            }),
        ...
        renderFgSegs: function(t) {
            ...
            t.length ? this.renderSegList(t) : (this.renderEmptyMessage(), t)
        },
        ...
        renderSegList: function(e) {
            ...
            o = s.find("tbody");
            for (this.sortEventSegs(e), n = 0; n < e.length; n++) i = e[n],
            r && i.start.isSame(r, "day") || (r = i.start.clone().stripTime(), o.append(this.dayHeaderHtml(r))),
            o.append(i.el);
