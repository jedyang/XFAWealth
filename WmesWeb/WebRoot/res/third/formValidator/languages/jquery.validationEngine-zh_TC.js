        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "phone": {
                    ...
                    "regex": /^0\d{2,3}-?\d{7,8}$/,
                    "alertText": "* 無效的電話號碼<br/>例：020-1234567"
                },
				"telephone":{   
				...
				"ajaxUserCallPhp": {
                    ...
                    "alertTextOk": "* 此賬號名稱可以使用",
                    "alertText": "* 此名稱已被其他人使用",
                    "alertTextLoad": "* 正在確認賬號名稱是否有其他人使用，請稍等。"
                },
                "ajaxNameCall": {
            	...
            	"loginCodeReg": {
                    "regex": /^\w+$/,
                    "alertText": "* 只能填寫字母、數字、下劃線"
                },
            	"pswRuleCustome":{
            		"regex":/(?=.*[a-z])(?=.*\d)(?=.*[#@!~%^&*_-])[a-z\d#@!~%^&*_-]{7,20}/i,
            		"alertText":"密碼必須包含：字母+數字+特殊字符(例如：@.&~%#_-其中一個或多個)!"
            	}
            };
