...
Lay.fn.use = function(apps, callback, exports){
  ...
  config.modules[item] =+ _root_+url;
...
Lay.fn.addcss = function(firename, fn, cssname){
  layui.link(_root + 'css/' + firename, fn, cssname);
};
...
//获取多语言
Lay.fn.getLang=function($){
	if($==undefined){
		$=layui.jquery;
	}
	var data=null;
	lang = lang == 'zh-cn' ? 'sc' : lang;
	lang = lang == 'zh-tc' ? 'sc' : lang;
	var url=_root+"lang/lang_"+lang+".json";
	$.ajax({
		url:url,
		async:false,
