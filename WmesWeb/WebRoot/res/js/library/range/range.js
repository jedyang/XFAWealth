...
//				console.log(this.leftValue.parents(".screener-attributes-show").attr("data-criteria"));
				...
				if( "trailingYTD,trailing1Mon,trailing3Mon,trailing6Mon,trailing1Year,trailing1Year,trailing3Year,trailing5Year,sinceLaunch,".indexOf(criteria) > -1 ){
					...
					fromValue = parseFloat(fromValue)/100.0;
					toValue = parseFloat(toValue)/100.0;
					$("#"+criteria).val(fromValue.toFixed(4)+","+toValue.toFixed(4));
//					console.log(fromValue);
//					console.log(toValue);
				}
				
		    	// 延时获取数据
				clearTimeout(this.dataTask);
		    	this.dataTask = setTimeout(function(){
