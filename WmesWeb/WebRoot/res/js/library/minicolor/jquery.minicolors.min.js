...
function(e) {
	function t(t, n) {
		...
		n.position !== undefined && e.each(n.position.split(" "),
		function() {
		...
		if (!n.inline) {
			...
			t.next(".minicolors-swatch").on("click",
			function(e) {
				e.preventDefault();
				t.focus()
			})
	...
	function i() {
		e(".minicolors-input").each(function() {
			...
			r = t.parent();
			if (n.inline) return;
			r.find(".minicolors-panel").fadeOut(n.hideSpeed,
			function() {
	...
	e(document).on("mousedown.minicolors touchstart.minicolors",
	function(t) {
